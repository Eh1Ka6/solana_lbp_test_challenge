...
export class MathSol {
    ...
    static divDownFixed(a: bigint, b: bigint): bigint {
        ...
        if (a == BZERO) {
            ...
            //console.log("divDown a_inflated", aInflated)
       
            //console.log("result ",         aInflated / b)
    ...
    static divUpFixed(a: bigint, b: bigint): bigint {
        ...
        if (a == BZERO) {
            ...
            // divUp(x, y) := (x - 1) / y + 1
            // Note that this requires x != 0, which we already tested for.
           /* //console.log("divUP a_inflated", aInflated)
            //console.log("a_inflated -bone ", aInflated - BONE)
            //console.log("b +bone ", b + BONE)*/
    ...
    static mulDownFixed(a: bigint, b: bigint): bigint {
        const product = a * b;
        /*//console.log("mulDownFixed a",a)
        //console.log("mulDownFixed b",b)
        //console.log("mulDownFixed res",product / this.ONE)*/
        _require(a == BZERO || product / a == b, 'Errors.MUL_OVERFLOW');
